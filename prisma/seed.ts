...
async function main() {
  ...
  await prisma.videoCallSignal.deleteMany();
  await prisma.videoCallRecording.deleteMany();
  await prisma.videoCallRoom.deleteMany();
  ...
  await prisma.widgetOrigin.deleteMany();
