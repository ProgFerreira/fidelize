...
export const PERMISSION_LABELS: Record<PermissionCode, string> = {
  ...
  [PERMISSIONS.AGENDA_MANAGE]: "Gerenciar agenda",
  [PERMISSIONS.PROFESSIONALS_MANAGE]: "Gerenciar profissionais",
  [PERMISSIONS.SERVICES_MANAGE]: "Gerenciar serviços / tipos de atendimento",
